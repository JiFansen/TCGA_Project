...
write.table(data.brca,paste(inputName,"_rsubread_Mutation_Correct.txt",sep=), sep = '\t')
...
example_large_scale = SIMLR(X = data.brca, c = 8)
...
pdf(file=paste(inputName,"_",featureName,"_Mutation_Correct.pdf",sep=''),width=28, height=7)
