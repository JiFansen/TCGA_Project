...
score.correction <- read.table(file="/Share/home/lanxun5/Data/TCGA/MAF_TCGA/csv_format/newresult/score.correction",header=T,sep="\t")
...
for (x in 1:32){
  ...
  maf.data <- read.csv(file=filename,header=T,fileEncoding="GBK")
  #setwd("D:/senior_year/R/MAF")
  ...
  setwd("/Share/home/lanxun5/Data/TCGA/MAF_TCGA/csv_format/FrameshiftResults")
  frameshift <- read.table(file=paste(cancertype,"result",sep=""),header=T,sep=" ")
  #setwd("D:/senior_year/R/MAF")
  setwd("/Share/home/lanxun5/Data/TCGA/MAF_TCGA/csv_format")
  ...
  setwd("/Share/home/lanxun5/Data/TCGA/MAF_TCGA/csv_format/mutation_frameshift")
...
x=33
cancertype <- "SKCM"
maf.data <- read.csv(file="TCGA.SKCM.varscan.txt",header=T,sep = "\t",fileEncoding="GBK")
useful.name <- c("Hugo_Symbol","Variant_Classification","Variant_Type",
                 "Reference_Allele","Tumor_Seq_Allele2","Consequence",
                 "Amino_acids","Codons","VARIANT_CLASS","CONTEXT","Protein_position","Tumor_Sample_Barcode")
maf.data <- maf.data[,match(useful.name,colnames(maf.data))]
